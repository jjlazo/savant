...
def change_potd():
    ...
    with app.app_context():
        ...
        non_potd = Poem.query.filter(Poem.potd==False).all()
        # print(">>>>>>>>old potd",old_potd)
        # print(">>>>>>>> non potd",non_potd)
...
scheduler.add_job(change_potd, 'cron', hour=0)
# scheduler.add_job(change_potd, 'interval', seconds=30)
scheduler.start()
